...
const ResultsSection = () => {
  ...
  return <section ref={ref} id="resultados" className="py-24 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-20">
          ...
          delay: index * 0.1
              ...
              <div className="relative inline-block mb-4">
                {index === 1 && <div className="absolute -left-4 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-accent animate-pulse" />}
