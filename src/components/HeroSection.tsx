...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center pt-20 overflow-hidden cosmic-bg">
      {/* Animated Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.8,
          delay: 0.3
        }} className="relative items-center justify-start flex flex-row text-secondary pl-[10px] px-0 shadow-none">
            <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 via-transparent to-accent/10 rounded-full blur-3xl" />
            <motion.img alt="Orvia Logo" className="relative z-10 w-full max-w-lg float-animation mix-blend-screen" animate={{
            scale: [1, 1.02, 1]
          }} transition={{
            duration: 4,
            repeat: Infinity,
